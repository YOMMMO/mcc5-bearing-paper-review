...
| Same-date and severity-matched fault-location separability remains possible, but date/class/severity structure prevents a session-independent claim | `evidence/within_date_250707_summary.csv`; `evidence/within_date_severity_matched_summary.csv`; `evidence/training_only_metadata_baselines.csv`; `evidence/outer_race_date_summary.csv`; `evidence/outer_race_date_severity_baseline_summary.csv` | `review/SESSION_CONFOUNDING_AUDIT.md`; `src/experiments/exp39_peer_review_controls.py` |
